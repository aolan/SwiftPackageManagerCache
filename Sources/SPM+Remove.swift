...
extension SPM {
    ...
    struct Remove: ParsableCommand {
        ...
        @Argument(help: "本地镜像仓库路径，示例：/Users/xxx/Library/Caches/com.lawn.spm.tool/repos_mirror/SnapKit/SnapKit.git")
        var path: String
        
        mutating func run() throws {
            
            guard let remoteURLString = SPM.toRemoteURLString(path) else {
                throw SPMError.invaildLocalRepo("本地镜像仓库链接不合法，示例：/Users/xxx/Library/Caches/com.lawn.spm.tool/repos_mirror/SnapKit/SnapKit.git")
            }
            ...
            let command = "git config --local --unset-all url.'\(remoteURLString)'.insteadOf \(path)"
